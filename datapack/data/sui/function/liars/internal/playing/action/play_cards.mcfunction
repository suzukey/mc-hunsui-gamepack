...
# 選択したカード数を取得
execute store result score #selected_count liars.game run clear @s carrot_on_a_stick[custom_data~{selected:1b}] 0
...
# 選択したカードをクリア
clear @s carrot_on_a_stick[custom_data~{selected:1b}]
